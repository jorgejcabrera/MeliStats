		...
		<div class="container" style="width:92%">
			<div style="position:relative; top:50px;"> 
				<aside style="font-style: arial; float: left; margin-left:116px">
					<h1 style="margin-left: 8px; text-align: left; color: #000;"> <span class="label label-danger">Mis preferencias</span> </h1>

						<input class="btn btn-danger" style="width: 42px; height: 41px; margin-top: -72px; margin-left: 261px; font-weight: bold; font-size: 20px;" type="button" value="+" data-toggle="modal" data-target="#myModal"></input>
		  					...
		  					<div class="modal-dialog">
								<div class="modal-content">
				      				<div class="modal-header">
				        				...
				        				<h4 class="modal-title" style="text-align: center" id="myModal">Crear nueva preferencia</h4>
		      						</div>
			     							...
			     							<div class="row featurette">
			          							<g:form controller="MiPerfil" action="nuevaPref" method="post">
							                       <div>
	        			                				...
	        			                				<input type="text" placeholder="Ingrese el nombre elegido" id="campoNombre" style="width:100%;" name="nombrePref" required>
				                    				</div> <br>
	        			            				<div>
	                    			    				<h4 class="featurette-heading">¿Cuánto le importa que el precio sea barato?</h4>
	                    							...
	                    							<br><br>
				                       				...
				                       				<button id="botonAgregarPreferencia" class="btn btn-danger" controller="MiPerfil" action="nuevaPref"><a style="color: white">Agregar</a> </button>
			     				               </g:form>  
		...
		-->				
					...
					<g:each in="${preferencias}" var="pref">
						<div class="jumbotron" style="width: 420px; height: 220px; position: relative; margin-left: -50px; margin-bottom: -11px;">
							<form id="formPref${pref.id}" action="${createLink(controller: 'miPerfil', action: 'guardarCambiosPref')}" method="post">
								...
								<div style="margin-left: -5px;"> Importancia precio barato: <input type="range" min="0" max"10" id="campoPrecio${pref.id}" name="precioPref" value="${pref.precioPref}" disabled></div>
							...
							<g:form controller="MiPerfil" action="eliminarPref">
								<input type="hidden" name="idPreferencia" value="${pref.id}" />
								<input type="submit" class="btn btn-danger" style="margin-left: 66px; margin-top: -56px;" value="Eliminar" id="btnEliminarPref" controller="MiPerfil" action="eliminarPref" name="EliminarPref"/>
							</g:form>
						</div><br><br>
					</g:each>
				</aside>
			...
			<div style="position:relative; top:50px; left:50px"> 
				<aside style="font-style: arial; float: right; margin-right:180px">
					<h1 style="text-align:center; margin-bottom:29px;   margin-left: -23px; color: #000;"> <span class="label label-danger">Mis búsquedas</span></h1>
