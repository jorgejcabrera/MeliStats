...
function mostrarLinkEstadisticas() {
	var link = '<h4><a href="/MeliStats/estadisticas/' + ultimabusqueda
			+ '">Ver Estadsitcas Completas</a></h4>'
...
function mostrarPorcentajeEnvio(porcentaje) {
	...
	(function drawChart() {
		var data = google.visualization.arrayToDataTable([ [ '', '' ],
				[ 'Gratis', porcentaje ], [ 'Pago', (100 - porcentaje) ], ]);
...
function mostrarMejoresResultados(resultados) {
	for (var i = 0; i < resultados.length; i++) {
		...
		$('#body-productos').append(
				'<tr><td><a href="' + link + '">' + titulo + '</a></td></tr>')
